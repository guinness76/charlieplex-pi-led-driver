...
class JsonLoader:
    ...
    def load_character_file(self):
        ...
        #     print("key=%s, value=%s" % (key, str(json_data[key])))
    ...
    def loadFrames(self):
        ...
        for frame in frames_json:
            ...
            if 'data' in frame.keys(): 
                frame_layers = frame['data']
                for layer in frame_layers:
                    piFrame.static_data.append(layer)
                pass
            elif 'animations' in frame.keys():
                ...
                print("Warning! Neither static data nor animations were defined in json file.")
            ...
            if 'transform' in frame.keys():
                ...
                if transform_json['type'] == 'translation':
                    loop_static_data = False
                    if "loop_static_data" in transform_json:
                        loop_static_data = transform_json['loop_static_data']
